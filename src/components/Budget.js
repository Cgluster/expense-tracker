...
export default function Budget({ budget }) {
    ...
    const getFundsRemaining = (amount) => {
    ...
    const fundsRemaining = getFundsRemaining(remainingFunds);
    ...
    return (
        <li className="budget-container">
            ...
            <h4 className={`remaining funds ${fundsRemaining}`}>Funds remaining: {remainingFunds}</h4>
        </li>
    )
}